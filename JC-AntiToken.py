...
class BurpExtender(IBurpExtender,IContextMenuFactory,IHttpListener,ISessionHandlingAction,ITab):
    ...
    def drawUI(self):
        ...
        # panel_url = JPanel()
        # panel_url.add(jlabel_url)
        # panel_url.add(self.jtext_url)
        # panel_url.setBorder(BorderFactory.createLineBorder(Color.red, 3))
        hbox_url = Box.createHorizontalBox()
        # hbox_url.add(panel_url)
        ...
        # panel_reqMeth = JPanel()
        # panel_reqMeth.add(jlabel_reqMeth)
        # panel_reqMeth.add(self.jcombobox_reqMeth)
        hbox_reqMeth = Box.createHorizontalBox()
        # hbox_reqMeth.add(panel_reqMeth)
        ...
        # panel_contentType = JPanel()
        # panel_contentType.add(jlabel_contentType)
        # panel_contentType.add(self.jcombobox_contentType)
        hbox_contentType = Box.createHorizontalBox()
        # hbox_contentType.add(panel_contentType)
        ...
        # panel_headers = JPanel()
        # panel_headers.add(jlabel_headers)
        # panel_headers.add(self.jtext_headers)
        hbox_headers = Box.createHorizontalBox()
        # hbox_headers.add(panel_headers)
        ...
        # panel_data = JPanel()
        # panel_data.add(jlabel_data)
        # panel_data.add(self.jtext_data)
        hbox_data = Box.createHorizontalBox()
        # hbox_data.add(panel_data)
        ...
        # panel_token_header = JPanel()
        # panel_token_header.add(jlabel_tokenName)
        # panel_token_header.add(self.jtext_tokenName)
        # vbox_token_header.add(panel_token_header)
        ...
        # panel_token_body = JPanel()
        # panel_token_body.add(jlabel_tokenRegex)
        # panel_token_body.add(self.jtext_tokenRegex)
        # panel_token_body.setBorder(BorderFactory.createLineBorder(Color.green, 3))
        # vbox_token_body.add(panel_token_body)
        ...
        jtext_gluetest2.setMaximumSize(Dimension(1000000009,1000000009))
